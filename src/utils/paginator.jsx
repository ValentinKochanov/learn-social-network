...
const Paginator = (props) => {
  ...
  let rigthPortionLeftNumber = portionNumber * props.paginatorSize;
  if (props.currentPage < leftPortionLeftNumber || props.currentPage > rigthPortionLeftNumber) {
    props.onPageChanged(leftPortionLeftNumber)};
  let pages =[];
  ...
  return (
    <div>
      ...
      { pagesCount > portionNumber && <button onClick={
